...
"""
expand header files and prepare for submission.
modified from https://github.com/atcoder/ac-library
"""
#!/usr/bin/env python3
...
class Expander:
    atcoder_include = re.compile(
        r'#include\s*["<](competitive/[0-9A-Za-z_]*/[0-9A-Za-z_]*(|.hpp))[">]\s*')

    include_guard = re.compile(r'#.*COMPETITIVE_[A-Z_]*_HPP')
