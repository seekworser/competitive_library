...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/geometry/intersection.md
    document_title: intersection.hpp
    links: []
  ...
  code: "#pragma once\n#include \"competitive/std/std.hpp\"\n#include \"competitive/geometry/base.hpp\"\
    ...
    \ntemplate <typename T> bool intersect(const Segment<T> &s1, const Segment<T>\
    \ &s2, bool strict=false) {\n    if (strict) {\n        if (ccw(s1, s2.s, true)\
