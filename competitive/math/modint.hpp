...
// inline std::istream& operator>>(std::istream& is, atcoder::modint x) {ll a; is >> a; x -= x.val(); x += a; return is; }
// inline std::istream& operator>>(std::istream& is, atcoder::modint998244353 x) {ll a; is >> a; x -= x.val(); x += a; return is; }
// inline std::istream& operator>>(std::istream& is, atcoder::modint1000000007 x) {ll a; is >> a; x -= x.val(); x += a; return is; }
