...
data:
  ...
  bundledCode: "#line 2 \"competitive/std/std.hpp\"\n#include <bits/stdc++.h>\n#ifndef\
    ...
    \ std::istream& operator>>(std::istream& is, atcoder::modint998244353& x);\ninline\
    \ std::istream& operator>>(std::istream& is, atcoder::modint1000000007& x);\n\
    ...
    \ x);\ninline std::istream& operator>>(std::istream& is, atcoder::modint& x) {ll\
    \ a; is >> a; x = a; return is; }\ninline std::istream& operator>>(std::istream&\
    \ is, atcoder::modint998244353& x) {ll a; is >> a; x = a; return is; }\ninline\
    \ std::istream& operator>>(std::istream& is, atcoder::modint1000000007& x) {ll\
    \ a; is >> a; x = a; return is; }\ninline std::ostream& operator<<(std::ostream&\
    \ os, const atcoder::modint& x) { os << x.val(); return os; }\ninline std::ostream&\
    \ operator<<(std::ostream& os, const atcoder::modint998244353& x) { os << x.val();\
    \ return os; }\ninline std::ostream& operator<<(std::ostream& os, const atcoder::modint1000000007&\
