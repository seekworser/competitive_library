...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/graph/fast_dijkstra.md
    document_title: fast_dijkstra.hpp
    links: []
  ...
  code: "#pragma once\n#include \"competitive/std/std.hpp\"\n#include \"competitive/graph/graph.hpp\"\
    ...
    \ void dijkstra(const Graph<Cost>& G, int start, vector<Cost> &min_cost, vector<int>\
