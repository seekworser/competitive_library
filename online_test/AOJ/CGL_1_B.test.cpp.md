...
data:
  ...
  bundledCode: "#line 1 \"online_test/AOJ/CGL_1_B.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/1/CGL_1_B\"\
    ...
    */\ntemplate<typename T> struct Point {\n    T x, y;\n    Point(T x, T y) : x(x),\
    ...
    \ * @brief io.hpp\n * @docs docs/std/io.md\n */\n#line 8 \"online_test/AOJ/CGL_1_B.test.cpp\"\
    \nint main() {\n    using P = Point<Frac>;\n    using L = Line<Frac>;\n    ll\
    \ x1, y1, x2, y2;\n    cin >> x1 >> y1 >> x2 >> y2;\n    L l(P(x1, y1), P(x2,\
    \ y2));\n    int q;\n    cin >> q;\n    rep(_, q) {\n        int x, y;\n     \
  ...
  verifiedWith: []
documentation_of: online_test/AOJ/CGL_1_B.test.cpp
layout: document
redirect_from:
- /verify/online_test/AOJ/CGL_1_B.test.cpp
- /verify/online_test/AOJ/CGL_1_B.test.cpp.html
